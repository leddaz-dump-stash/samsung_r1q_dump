#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery$(getprop ro.boot.slot_suffix):82825216:2344e0360ff77b5e12fdf83f30f067ef94e7163f; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot$(getprop ro.boot.slot_suffix):67108864:1658b7c4332b4558ca87c61951a3d02fc2bd39e6 \
          --target EMMC:/dev/block/bootdevice/by-name/recovery$(getprop ro.boot.slot_suffix):82825216:2344e0360ff77b5e12fdf83f30f067ef94e7163f && \
